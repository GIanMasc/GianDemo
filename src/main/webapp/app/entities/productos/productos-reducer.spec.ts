...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './productos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOS actions', async () => {
      const expectedActions = [
        {
